...
const Footer = () => {
    return (
        <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 pb-8 md:pb-0 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32 bg-[radial-gradient(35%_128px_at_50%_0%,rgba(255,122,0,0.2),transparent)]">
            ...
            <div className="grid gap-8 xl:grid-cols-3 xl:gap-8 w-full">
                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        Shorten, track, and share links instantly.
                        </p>
                        <span className="mt-4 text-neutral-200 text-sm flex items-center">
                            Made by <Link href="https://github.com/duggal1/" className="font-semibold ml-1 text-orange-500 underline">LinkZap Team</Link>
                            
                           
                        </span>
                        <span className=' animate-pulse'> with ❤️</span>
                    </div>
                </AnimationContainer>
