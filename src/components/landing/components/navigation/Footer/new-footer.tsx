...
const Underline = `hover:-translate-y-1 rounded-xl hover:bg-white/10 hover:shadow-[0_4px_20px_rgba(255,255,255,0.5)] p-2.5 transition-all duration-300`;
export function NewFooter() {
  return (
    <AnimationContainer delay={0.1}>
    <footer className="border-zinc-900/80 px-4 mx-auto w-full border-b   border-t ">
    <AnimationContainer delay={0.1}>
      <div className="relative mx-auto grid  max-w-7xl items-center justify-center gap-6 p-10 pb-0 md:flex ">
        ...
        <p className="bg-transparent text-center text-xs leading-4 text-primary/60 md:text-left">
          ...
          an agency of one. This means you&lsquo;ll work directly with me, founder of
          Designali.
        </p>
      </div>
      </AnimationContainer>
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="border-b  border-zinc-600/80 border-dotted"> </div>
        <div className="py-10">
                  ...
                  >
                    {section.items.map((item) => (
                      <li key={item.name} className="flow-root">
                        <Link
                          href={item.href}
                          className="text-sm  hover:text-zinc-500 text-white md:text-xs"
                        >
                          {item.name}
                        </Link>
                      </li>
        ...
        <div className="border-b border-dotted border-zinc-600/80 "> </div>
      </div>
      </AnimationContainer >
      <AnimationContainer delay={0.1}>
