import { BarChart3Icon, BrainIcon, DollarSignIcon, FolderOpenIcon, WandSparklesIcon } from "lucide-react";
...
export const PROCESS = [
    {
        ...
        description: "Auto-categorize and tag links with AI for instant retrieval and management.",
        icon: FolderOpenIcon,
    },
    {
        title: "Branded Short Links",
        description: "Generate custom, branded short links with deep tracking and A/B testing capabilities.",
        icon: WandSparklesIcon,
    },
    {
        title: "AI-Powered Link Optimization",
        description: "Automatically optimize links based on audience behavior, device, and traffic source.",
        icon: BrainIcon, // Assuming an AI-related icon exists
    },
    {
        title: "Advanced Analytics & Attribution",
        description: "Granular analytics with multi-touch attribution, UTM enrichment, and conversion tracking.",
        icon: BarChart3Icon,
    },
    {
        title: "Monetize Your Traffic",
        description: "Monetize your links like a pro by integrating smart ads, affiliate tracking, and pay-per-click (PPC) models.",
        icon: DollarSignIcon,
    },
] as const;
