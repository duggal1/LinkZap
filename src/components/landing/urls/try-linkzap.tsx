    ...
    <div className="flex flex-1 flex-col items-center justify-center min-h-screen bg-transparent backdrop-blur-sm p-6 md:p-24">
      <div className="w-full max-w-3xl mx-auto text-center space-y-8">
        <div className="space-y-4">
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tighter bg-gradient-to-r from-white to-neutral-200 bg-clip-text text-transparent animate-gradient">
            Shorten Your Links
          </h1>
